...
const JobEntry: React.FC<JobEntryProps> = ({ job, onJobClick, selectedJob }) => {
  return (
    <div onClick={() => onJobClick(job)} className={`mx-5 mb-5 px-5 py-5 border border-gray-300 text-black ${selectedJob.id === job.id ? 'border-2 border-primary shadow-lg' : 'border-gray-300'} rounded-xl` }
    >
