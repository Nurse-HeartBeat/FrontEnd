...
return (
<div className="mt-0 flex rounded-lg bg-white mt-2 z-100 absolute flex-col items-center justify-center shadow-lg ring-2 ring-Primary right-5" style={{ width: '300px', maxHeight: '500px' }}>
