...
<div className="mt-0 flex rounded-lg bg-gray-300 mt-2 z-100 absolute flex-col items-center justify-center shadow-lg ring-2 ring-Primary right-5" style={{ width: '300px', maxHeight: '500px' }}>
  ...
  <div className='flex mt-5 mb-5'>
    ...
    <input type="date" id="date" name="date" value={startDate} min="2023-01-01" max="2023-12-31" onChange={(e)=> setStartDate(e.target.value)}/>
  </div>
  <div>
    <label htmlFor="date">End date:</label>
    <input type="date" id="date" name="date" value={endDate} min={startDate} max="2023-12-31" onChange={(e)=> setEndDate(e.target.value)}/>
  </div>
